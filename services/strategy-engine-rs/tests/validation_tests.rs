...
use strategy_engine_rs::validation::determinism::{DeterminismState, DeterminismValidator};
...
fn test_replay_correctness() {
    let events = vec![
        ValidationEvent::ValueAdded {
            amount: Decimal::new(10, 0),
        },
        ValidationEvent::Multiplied {
            factor: Decimal::new(2, 0),
        },
        ValidationEvent::ValueSubtracted {
...
fn test_event_rebuild() {
    let event = ValidationEvent::ValueAdded {
        amount: Decimal::ONE,
    };
