...
impl RegimeMemory {
    pub fn new() -> Self {
        ...
        memory.insert(MarketRegime::Trend, RegimeRecord {
            successful_strategies: vec![],
            optimal_symbols: vec![],
            max_drawdown_tolerated: Decimal::new(15, 0),
        });
        memory.insert(MarketRegime::Range, RegimeRecord {
            successful_strategies: vec![],
            optimal_symbols: vec![],
            max_drawdown_tolerated: Decimal::new(10, 0),
        });
        memory.insert(MarketRegime::HighVolatility, RegimeRecord {
            successful_strategies: vec![],
            optimal_symbols: vec![],
            max_drawdown_tolerated: Decimal::new(20, 0),
        });
        memory.insert(MarketRegime::LowVolatility, RegimeRecord {
            successful_strategies: vec![],
            optimal_symbols: vec![],
