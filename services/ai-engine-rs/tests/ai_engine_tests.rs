use ai_engine_rs::embeddings::EmbeddingsEngine;
use ai_engine_rs::feature_engineering::FeatureEngine;
use ai_engine_rs::pattern_recognition::PatternRecognizer;
use ai_engine_rs::regime_classifier::{MarketRegimeType, RegimeClassifier};
...
fn test_regime_classifier() {
    ...
    let regime = classifier.classify(
        ...
        Decimal::new(1, 0),
        Decimal::new(5000, 0),
    ); // Price change 0.6, vol 1.0, vol 5000
