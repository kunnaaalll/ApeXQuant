...
impl ReplayValidator {
    ...
    pub fn validate_replay(&self, initial_state: Option<LearningSnapshot>, events: &[(u64, LearningEvent)]) -> LearningSnapshot {
...
impl DeterminismValidator {
    ...
    pub fn verify_determinism(&self, initial_state: Option<LearningSnapshot>, events: &[(u64, LearningEvent)]) -> bool {
